...
export class RecoveryStore {
 ...
 async save(project:StudioProject){const bytes=encodeProject(project);await mkdir(this.directory,{recursive:true});await writeFile(this.file+'.tmp',bytes);await rename(this.file+'.tmp',this.file);}
