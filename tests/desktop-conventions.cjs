...
// config picker, right-click (erase while painting, the edit menu otherwise),
// Shift+H/V flips, docked properties, labeled undo steps, and the background
// layer's opaque color 0. Run with `npm run test:desktop:conventions`.
